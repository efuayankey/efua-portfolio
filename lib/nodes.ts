...
export const NODE_DEFS: NodeDef[] = [
  { id: 'center',     label: '',           color: '#e8552a', r: 82, tooltipDesc: 'CS + AI Researcher · Lehigh · 2028' },
  { id: 'research',   label: 'Research',   color: '#7ab8e8', r: 44, tooltipDesc: 'SWAT Lab · AIMES · GNN' },
  { id: 'projects',   label: 'Projects',   color: '#a8d8a8', r: 44, tooltipDesc: '5 projects · AI · Full-Stack' },
  { id: 'experience', label: 'Experience', color: '#f0c674', r: 40, tooltipDesc: '3 roles · Lehigh research labs' },
    ...
    items: [
      {
        ...
        meta: 'Feb 2026 – Present · Prof. Jeff Heflin',
...
:AURA :uses :AWSBedrock , :ClaudeAPI .`,
    items: [
      {
        name: 'HawkSearch',
        meta: 'Agentathon · Lehigh · April 2026 · Built in one night',
        desc: 'AI agent that scrapes all 5 Lehigh colleges\' faculty pages live, reasons over research profiles, scores student-professor compatibility, and drafts cold emails ready to send in one click. Claude API for reasoning and email generation.',
  ...
  experience: {
    ...
    rdf: `:Efua :workedAt :SWATLab , :WiNSLab ;
  :leads :NextToIntern .
...
:SWATLab :advisor :ProfHeflin .`,
    items: [
      {
        name: 'AI Researcher',
        meta: 'SWAT Lab · Lehigh University · Feb 2026 – Present',
  ...
  skills: {
    ...
    skillGroups: [
      ...
      {
        category: 'Frameworks',
        skills: ['Next.js', 'React', 'FastAPI', 'Flask', 'Node.js', 'Express', 'Spring Boot', 'Firebase', 'GraphQL'],
      },
      {
        category: 'Infrastructure',
        skills: ['AWS', 'Docker', 'Kubernetes', 'PostgreSQL', 'Redis', 'DynamoDB', 'Kafka', 'CI/CD', 'Git', 'Linux'],
      },
    ],
  },
...
:RossinFellowship :nominatedBy :Faculty , :Dean .`,
    ...
    memberships: ['ColorStack', 'NSBE', 'RARE Scholar', 'AI-4ALL Ignite', 'WiCS', 'ISAB'],
  },
...
:HawkSearch :builtIn "one night" ;
  ...
  :does "faculty matching + cold email drafting" .`,
    ...
    items: [
      {
        name: 'HawkSearch',
        meta: 'Agentathon · Lehigh University · April 2026',
        desc: 'Built overnight at Lehigh\'s first AI agent hackathon. Scrapes all 5 college faculty pages live, reasons over research profiles using Claude API, scores student-professor fit, and drafts a personalized cold email ready to send in one click. No pre-loaded data — it fetches and reasons in real time.',
        tags: ['Claude API', 'Next.js', 'AI Agents', 'Web Scraping', 'TypeScript'],
        link: 'https://github.com/efuayankey',
      },
    ],
  ...
  :targeting :JaneStreet , :HRT ,
             :Citadel , :TwoSigma ,
             :Anthropic , :NVIDIA .`,
    contactCopy: 'Currently recruiting for Summer 2027. Targeting SWE, MLE, and quant-adjacent roles — Jane Street, HRT, Citadel, Two Sigma, Anthropic, NVIDIA, high-performance tech. If you\'re building something real, she wants to hear about it.',
    links: [
      { label: 'Email Me', href: 'mailto:efuayankey123@gmail.com', primary: true },
      { label: 'LinkedIn ↗', href: 'https://linkedin.com/in/efuayankey' },
      { label: 'GitHub ↗', href: 'https://github.com/efuayankey' },
